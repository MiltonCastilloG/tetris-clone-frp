export const CLOCK_TICK_MS = 400; // in ms
...
export const LOCKED_MAP_ROW = Array.from(
  { length: HORIZONTAL_DIMENSIONS },
  () => 0
);
export const LOCKED_MAP = Array.from({ length: VERTICAL_DIMENSIONS }, () => [
  ...LOCKED_MAP_ROW,
]);
...
export const BASE_LINE_CLEAR_SCORE = [40, 100, 300, 400];
